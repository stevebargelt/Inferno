...
namespace Inferno.Api.Services
{
    public class Smoker : ISmoker
    {
        ...
        public Temps Temps => new Temps()
        {
            ...
            Probe1Temp = Double.IsNaN(_rtdArray.Probe1Temp) ? -1 : _rtdArray.Probe1Temp,
            Probe2Temp = Double.IsNaN(_rtdArray.Probe2Temp) ? -1 : _rtdArray.Probe2Temp,
            Probe3Temp = Double.IsNaN(_rtdArray.Probe3Temp) ? -1 : _rtdArray.Probe3Temp,
            Probe4Temp = Double.IsNaN(_rtdArray.Probe4Temp) ? -1 : _rtdArray.Probe4Temp
        };
