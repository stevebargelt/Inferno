...
namespace Inferno.Cli
{
    class Program
    {
        ...
        static async Task PrintStatus()
        {
            ...
            Console.WriteLine();
            Console.WriteLine($"Grill temp: " + ((status.Temps.GrillTemp > 0) ? status.Temps.GrillTemp.ToString() + "*F" : "Unplugged"));
            Console.WriteLine($"Probe1 temp: " + ((status.Temps.Probe1Temp > 0) ? status.Temps.Probe1Temp.ToString() + "*F" : "Unplugged"));
            Console.WriteLine($"Probe2 temp: " + ((status.Temps.Probe2Temp > 0) ? status.Temps.Probe2Temp.ToString() + "*F" : "Unplugged"));
            Console.WriteLine($"Probe3 temp: " + ((status.Temps.Probe3Temp > 0) ? status.Temps.Probe3Temp.ToString() + "*F" : "Unplugged"));
            Console.WriteLine($"Probe4 temp: " + ((status.Temps.Probe4Temp > 0) ? status.Temps.Probe4Temp.ToString() + "*F" : "Unplugged"));
            Console.WriteLine();
